              ...
              >
                <Card className="group relative h-full overflow-hidden border border-border bg-card shadow-xl shadow-orange-200/40 transition transform-gpu hover:border-orange-300 hover:bg-orange-50/60 hover:shadow-orange-300/50">
                  {integration.isOptional && (
                    <div className="absolute right-6 top-6 rounded-full border border-orange-300 bg-orange-100 px-3 py-1 text-xs uppercase tracking-[0.28em] text-orange-800">
                      Optional
                    </div>
                  )}
                  ...
                  >
                    ...
                    >
                      <integration.icon className="h-6 w-6 text-orange-700" />
                    </motion.div>
                    ...
                    <div className="flex flex-col gap-2 flex-1">
                      ...
                      {isLast && (
                        <CardDescription className="text-base text-muted-foreground md:text-lg mt-2">
